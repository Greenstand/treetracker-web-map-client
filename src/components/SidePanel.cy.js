...
describe('SidePanel', () => {
  ...
  it('SidePanel shown and turn to next page', () => {
    const trees = [
      ...
      },
      {
        ...
        last_name: 'David',
        image_url:
          'https://treetracker-dev.nyc3.digitaloceanspaces.com/2018.09.07.11.04.27_3ae160d9-58f7-4373-a4c2-3b39edbacd2e_IMG_20180907_095704_764193446.jpg',
        user_image_url:
          'https://treetracker-production.nyc3.digitaloceanspaces.com/Miti%20Aliance%20Image2.png',
        id: 2,
        time_created: new Date(),
        domain_specific_data: {},
        attributes: {},
  ...
  it('SidePanelEmpty', () => {
    ...
    cy.get("div[title='show']").should('not.exist');
  });
