...
// https://dev-k8s.treetracker.org/img/img/:domain/:params/:image
// E.g.,
// https://dev-k8s.treetracker.org/img/img/treetracker-dev-images.s3.eu-central-1.amazonaws.com/w=300,h=400,r=90/2020.05.19.15.41.53_37.421998333333335_-122.08400000000002_c36747a4-101f-43ff-9a91-45b3cb9bfd01_IMG_20200515_141055_7587706704717292658.jpg
...
const getThumbnailImageUrls = (imageUrl, width = 400, height = 400) => {
  ...
  const thumbNailImageUrl = `${process.env.NEXT_PUBLIC_IMAGE_API}/images/${domain}/${paramUrl}/${imagePath}`;
